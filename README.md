...
The current implementation on `main` includes **Phase 9 — Reliable, resumable workflows**, merged in PR #6 (`12cd7f5`). Phases 7–9 add guided todo creation, server-directed screens, and owner-scoped discovery/resume with revision checks and idempotent request recovery. Earlier numbered guides and checkpoints remain available.
